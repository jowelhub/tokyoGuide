...
VALUES
  ...
  ('tokyo-tower', 'Tokyo Tower', 'Iconic communications and observation tower, inspired by the Eiffel Tower.', 'landmark', 35.6586, 139.7454, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('imperial-palace-east-garden', 'Imperial Palace East Garden', 'Former site of Edo Castle''s innermost circles, now a public park with historical ruins.', 'garden', 35.6874, 139.7547, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('odaiba', 'Odaiba', 'Man-made island in Tokyo Bay featuring shopping malls, museums, and futuristic architecture.', 'district', 35.6300, 139.7759, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('tokyo-disneyland', 'Tokyo Disneyland', 'Popular theme park based on the films produced by Walt Disney, located in Urayasu, Chiba.', 'theme-park', 35.6329, 139.8804, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('nezu-museum', 'Nezu Museum', 'Features a collection of Japanese and East Asian art, set within a beautiful traditional garden.', 'museum', 35.6651, 139.7148, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('yanaka-ginza', 'Yanaka Ginza', 'Traditional shopping street with a nostalgic atmosphere, offering local foods and crafts.', 'shopping', 35.7255, 139.7675, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('shimokitazawa', 'Shimokitazawa', 'Trendy neighborhood known for its vintage clothing stores, independent boutiques, cafes, and live music venues.', 'district', 35.6630, 139.6670, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('tokyo-metropolitan-govt-building', 'Tokyo Metropolitan Government Building', 'Offers free panoramic views of Tokyo from its observation decks in Shinjuku.', 'landmark', 35.6896, 139.6917, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('asakusa-district', 'Asakusa District', 'Historic district centered around Senso-ji Temple, offering traditional shops, food, and atmosphere.', 'district', 35.7118, 139.7964, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('rikugien-garden', 'Rikugien Garden', 'Considered one of Tokyo''s most beautiful Japanese landscape gardens, especially popular during autumn.', 'garden', 35.7330, 139.7468, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('tokyo-disneysea', 'Tokyo DisneySea', 'Unique Disney theme park with nautical exploration themes, located next to Tokyo Disneyland.', 'theme-park', 35.6267, 139.8850, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('shinjuku', 'Shinjuku', 'Major commercial and administrative center, housing the busiest railway station in the world, skyscrapers, shops, and entertainment.', 'district', 35.6909, 139.7004, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('tokyo-station', 'Tokyo Station', 'Historic railway station with beautiful architecture, serving as a major transportation hub and shopping complex.', 'landmark', 35.6812, 139.7671, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('rainbow-bridge', 'Rainbow Bridge', 'Large suspension bridge crossing northern Tokyo Bay, connecting Shibaura Pier to Odaiba.', 'landmark', 35.6453, 139.7617, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('edo-tokyo-museum', 'Edo-Tokyo Museum', 'Museum showcasing the history and culture of Tokyo from the Edo period to the present day (Note: Currently closed for major renovations).', 'museum', 35.6967, 139.7969, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('nakano-broadway', 'Nakano Broadway', 'Shopping complex famous for its numerous stores selling anime, manga, and otaku collectibles.', 'shopping', 35.7089, 139.6657, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('omoide-yokocho', 'Omoide Yokocho (Memory Lane)', 'Network of narrow alleys in Shinjuku filled with tiny eateries serving yakitori and ramen.', 'food', 35.6931, 139.7000, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('gotokuji-temple', 'Gotokuji Temple', 'Buddhist temple famous for its thousands of maneki-neko (beckoning cat) figurines.', 'shrine', 35.6480, 139.6470, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('mori-art-museum', 'Mori Art Museum', 'Contemporary art museum located on the top floors of the Roppongi Hills Mori Tower.', 'museum', 35.6605, 139.7290, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('kappabashi-kitchen-town', 'Kappabashi Kitchen Town', 'Street lined with shops selling everything related to kitchenware, restaurant supplies, and plastic food samples.', 'shopping', 35.7140, 139.7875, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('sumida-aquarium', 'Sumida Aquarium', 'Modern aquarium located at the base of Tokyo Skytree, featuring penguins and jellyfish exhibits.', 'activity', 35.7100, 139.8100, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('tokyo-dome-city', 'Tokyo Dome City', 'Entertainment complex featuring Tokyo Dome stadium, an amusement park, shops, restaurants, and a spa.', 'activity', 35.7056, 139.7519, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('yasukuni-shrine', 'Yasukuni Shrine', 'Shinto shrine dedicated to those who died serving Japan, also housing the Yushukan war museum.', 'shrine', 35.6945, 139.7448, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('shibuya-sky', 'Shibuya Sky', 'Observation deck offering 360-degree panoramic views of Tokyo from atop the Shibuya Scramble Square building.', 'activity', 35.6590, 139.7023, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('suga-shrine-stairs', 'Suga Shrine Stairs (Your Name)', 'Iconic red-railed stairs featured prominently in the anime movie "Your Name".', 'landmark', 35.6846, 139.7191, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written. Stairs leading up to Suga Shrine in Yotsuya, famously depicted in the final scenes of Makoto Shinkai''s "Your Name".'),
  ('ikebukuro', 'Ikebukuro District', 'Major commercial and entertainment district, known for Sunshine City, Otome Road (female otaku culture), and department stores.', 'district', 35.7295, 139.7110, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written. Features Sunshine City complex (aquarium, observation deck, planetarium), Otome Road for female-oriented anime/manga goods, and large electronics stores.'),
  ('kichijoji', 'Kichijoji', 'Popular residential area known for Inokashira Park, Ghibli Museum (nearby), shopping streets, and relaxed atmosphere.', 'district', 35.7030, 139.5800, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('tokyo-international-forum', 'Tokyo International Forum', 'Exhibition center and concert hall complex known for its striking glass and steel architecture.', 'landmark', 35.6767, 139.7638, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('zojoji-temple', 'Zojoji Temple', 'Large Buddhist temple located next to Tokyo Tower, known for its massive Sanmon gate.', 'shrine', 35.6570, 139.7485, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.'),
  ('suntory-museum-of-art', 'Suntory Museum of Art', 'Museum in Tokyo Midtown focusing on "Art in Life", showcasing Japanese paintings, ceramics, textiles, and glass.', 'museum', 35.6660, 139.7316, '["https://images.unsplash.com/photo-1624253321171-1be53e12f5f4", "https://images.unsplash.com/photo-1624253321171-1be53e12f5f4"]'::jsonb, 'Details need to be written.');
